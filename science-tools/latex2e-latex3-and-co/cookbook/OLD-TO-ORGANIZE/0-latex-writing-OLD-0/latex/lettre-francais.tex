...
\begin{document}
	\begin{letter}{Madame Tagada\\ % Destinataire
		           12 rue des fraises\\
		           29300 Uneville} 
		\address{Pierre Fritsch\\ % Mon adresse
		         Alfred-Messel-Weg 6-111\\
				 64287 Darmstadt}
		\name{Pierre Fritsch} % Mon nom
		%\location{Mon département dans l'entreprise}
		\telephone{+49 176 123 455 67}
		\email{pierre.fritsch@provider.de}
		...
		\lieu{Darmstadt} % L'endroit d'où j'écris
