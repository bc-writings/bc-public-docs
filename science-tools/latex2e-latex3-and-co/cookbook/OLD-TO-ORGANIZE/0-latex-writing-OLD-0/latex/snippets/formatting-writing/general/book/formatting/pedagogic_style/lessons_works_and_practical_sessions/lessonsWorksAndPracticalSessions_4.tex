% Source : http://forum.mathematex.net/latex-f6/realisation-d-un-document-type-pour-taper-ses-cours-t13221-60.html#p135256
    ...
    \titlecontents{part}
      [0em]
      {\addvspace{1pc}\global\justafterlparttrue\formattableofcontentspart}
    ...
    \subsubpart{\'Electromagn\'etisme}

    Bla bla de pr\'esentation sur l'\'electromagn\'etisme.\index{Physique!\'Electromagn\'etisme}
    ...
    \renewcommand*{\l@chapter}[2]{%
      ...
      \fi}
    \makeatother
    \setlength{\lchapterrulewidth}{0.4pt}
    \setlength{\lchapterrulesep}{0pt}
