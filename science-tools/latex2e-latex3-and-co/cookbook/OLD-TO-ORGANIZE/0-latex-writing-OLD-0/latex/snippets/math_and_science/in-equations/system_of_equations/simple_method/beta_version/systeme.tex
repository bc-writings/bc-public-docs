...
\SYS@newmacro\SYS@ver        {0.2beta}
\SYS@newmacro\SYS@date       {2011/03/06}
\SYS@newmacro\SYS@longdate   {6 mars 2011}
...
% d\'efinit ce qu'est le séparateur des équations par défaut
...
\SYS@newmacro\SYS@spliteqinterms#1{%
	\IfSubStr{\noexpand#1}\SYS@extracolsign% y a t-il un signe de colonne suppl\'ementaire ?
		...
		\expandafter\let\csname SYS@extracol@\SYS@eqnumber\endcsname\SYS@rightmember
		\SYS@extracoltrue
		}%
...
\SYS@newmacro\SYS@assignterm{%
	...
	\else
		...
		\fi
	\fi
	\expandafter\let\csname SYS@sign@\detokenize\expandafter{\SYS@letterfound}@\SYS@eqnumber\endcsname\SYS@currentsign% proc\'eder aux assignations
	\expandafter\let\csname SYS@term@\detokenize\expandafter{\SYS@letterfound}@\SYS@eqnumber\endcsname\SYS@currentterm
}

% cherche la premi\`ere lettre minuscule dans #1
\SYS@newmacro\SYS@findletter#1{%
	\def\SYS@currentfindletter{#1}%
...
\SYS@newmacro\SYS@testsubscript{%
	...
	\IfBeginWith\SYS@currentfindletter_%
		...
		\IfInteger\SYS@currentletterafter\relax{\errmessage{L'indice n'est pas un nombre entier !}}%
	...
	\else
		...
		\ifcsname SYS@extracol@#1\endcsname
			...
			\expandafter\IfSubStr\csname SYS@extracol@#1\endcsname{**}% le contenu de l'extra col contient-il "**" ?
				...
				\expandafter\let\csname SYS@extracol@#1\endcsname\SYS@currentautonum
				\SYS@autonumtrue
				}%
				{\expandafter\IfSubStr\csname SYS@extracol@#1\endcsname*% le contenu de l'extra col contient-il "*" ?
					{\expandafter\let\expandafter\SYS@autonumarg\csname SYS@extracol@#1\endcsname
...
\SYS@newmacro\SYS@systeme@i{%
	...
	\begingroup
		...
		\expandarg\noexploregroups
		\setbox\z@\hbox{$($}%
		\edef\SYS@strutup{\noexpand\vrule depth\z@ width\z@ height\dimexpr\ht\z@+\SYS@extrastrutdim\relax}%
		\edef\SYS@strutdown{\noexpand\vrule height\z@ width\z@ depth\dimexpr\dp\z@+\SYS@extrastrutdim\relax}%
		\let\++\let\--%
