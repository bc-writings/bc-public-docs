% Source : http://www.texample.net/tikz/examples/matrix-multiplication/
...
% Definition of the matrices
	...
	\matrix (B) [
		...
		{%
			b_{11} & \node[node style sp] {b_{12}}; & \ldots & b_{1q} \\
			b_{21} & \node[node style sp] {b_{22}}; & \ldots & b_{2q} \\
			\vdots & \vdots                         & \ddots & \vdots \\
...
% Product of the matrices
	\matrix (C) [
		...
		{%
			...
			c_{21} & \node[node style sp,red] {c_{22}}; & \ldots & c_{2q} \\
			\vdots & \vdots                             & \ddots & \vdots \\
