...
% Fractional writing of partial derivate
	...
	\newcommand\partialFracBasic[3][0]{%
		\def\deno{\StrSubstitute{ #3}{ }\partial} % This works because xstring traits {...} like a single character.
		\IfStrEq{#1}{0}{
			\ensuremath{\frac{\pp{#2}}{\deno}}
		}{
			\ensuremath{\frac{\pp^{#1}{#2}}{\deno}}
		}
	}

	\newcommand\partialFrac[3][0]{%
		\IfSubStr{#3}{\cdots}{%
			\StrBefore{#3}{\cdots}[\before]
			\StrBehind{#3}{\cdots}[\behind]
			\partialFracBasic[#1]{#2}{\before{\cdots} \behind}
		}{
			\partialFracBasic[#1]{#2}{#3}
		}
	}
