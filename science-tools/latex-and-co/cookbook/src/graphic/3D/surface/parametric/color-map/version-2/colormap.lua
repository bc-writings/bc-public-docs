...
------
function graph3d:draw_colormap(user_surface, user_palette, dir, backcull)
  local bary_bbox = get_bary_bbox(user_surface)

  local sorted_facets = self:Sortfacet(user_surface, backcull)
...
--              les ¨args ''user_surface'', ''user_palette'' et
--              ''backcull'', et en choisissant la ¨dir ''"x"''.
------
function graph3d:draw_colormap_X(user_surface, user_palette, backcull)
  self:draw_colormap(user_surface, user_palette, "x", backcull)
end
...
------
function graph3d:draw_colormap_Y(user_surface, user_palette, backcull)
  self:draw_colormap(user_surface, user_palette, "y", backcull)
end
...
------
function graph3d:draw_colormap_Z(user_surface, user_palette, backcull)
  self:draw_colormap(user_surface, user_palette, "z", backcull)
end
