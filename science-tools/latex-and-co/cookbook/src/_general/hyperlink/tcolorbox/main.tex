...
% Par contre, nous avons besoin de la \bib ''skins'' pour
% créer des hyperliens.
% Quant à la \bib ''minted'', elle est juste là pour proposer
% un code \python en exemple.
%%%
...
%%%
% Sans l'option ''enhanced'', nous n'avons pas de fonctionalité
% du type "hyperlien".
%
...
%
%     + ''hyperurl*'' permet d'employer des options ''hyperref''
%       pour le lien externe : par exemple, on peut indiquer à
%       quelle page ouvrir un PDF.
%%%
\begin{tcolorbox}[
  enhanced,
  ...
  Cliquer sur moi, vous saurez d'où vient le code utilisé pour produire ce document.
\end{tcolorbox}


Cette technique permet de proposer une version en ligne d'un code informatique difficilement copiable dans un PDF. Ai-je bien entendu ? Vous souhaitez aussi ne pas avoir de cadre, ni de rondeur ! Aucun souci.
...
%%%
  ...
  listing only,
%%%
% Réglages pour la mise en forme.
%%%
  sharp corners,
  colback  = orange!20,
  boxrule  = 0pt,
