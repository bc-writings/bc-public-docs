...
\begin{luadraw*}{name = matrix-kernel-transfo-by-hand}
------
-- Les deux ¨mats.
------
local mat_src = {
...
local A = ld.pt3d.M(3, 0, 0)
local B = ld.pt3d.M(-3, 0, 0)
local u = ld.pt3d.vecJ
local v = ld.pt3d.vecK
...
------
-- Mise en valeur d'une ¨modif via des segments.
------
local focus_segs = {
  {B + 2*u + v, A + 2*u + v},
  {B + 3*u + v, A + 4*u + v},
...
------
-- Ajout des parties cachées des segments.
------
graphview:Dpolyline3d(
  focus_segs,
