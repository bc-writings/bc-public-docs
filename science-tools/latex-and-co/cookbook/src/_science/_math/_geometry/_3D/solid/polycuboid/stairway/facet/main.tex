...
%%%
% src::
%   url = https://github.com/pfradin/luadraw/discussions/53#discussioncomment-14207791
%%%
...
local cube        = ld.parallelep(M(-5, -5, -5), vecI, vecJ, vecK)
  ...
  for j = nb_slices, 0, -1 do
    for k = 0, nb_slices - i do
      if j == 0 or k == nb_slices - i then
        table.insert(
          facets_n_options,
          ld.shift3d(cube_facets, i*vecI + j*vecJ + k*vecK)
        )
