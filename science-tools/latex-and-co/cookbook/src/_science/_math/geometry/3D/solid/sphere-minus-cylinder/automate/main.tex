...
------
local base = ld.circle3d(A, r, vecK)
local base = base[1]
...
for _, C in ipairs(base) do
  table.insert(
    cyl_border,
    C + sqrt(R^2 - ld.pt3d.abs2(C)) * vecK
  )
end
...
------
local cyl = ld.prism(ld.reverse(cyl_border), -4*vecK, true)

cyl = ld.cutpoly(cyl, {O, vecK})
