...
\usepackage{../common/main}

\directlua{dofile("../common/main.lua")}
...
------
local A     = ld.set(-1.75,90)
local lab_A = "$A$"
local col_A = SET_COL("Crimson")

local B     = ld.set(1.75, -90)
local lab_B = "$B$"
local col_B = SET_COL("ForestGreen")

local polyline_A_inter_B = ld.cap(ld.path(A), ld.path(B))
