...
L'aire algébrique nous sera néanmoins utile pour formuler un argument de continuité.


\begin{multicols}{2}
	\small\itshape\centering
	\includegraphics[scale=.3]{content/polygon/col-area/col-area-ncycle-not-opti-pb-1.png}

	\includegraphics[scale=.3]{content/polygon/col-area/col-area-ncycle-not-opti-pb-2.png}
\end{multicols}


Tout n'est pas perdu, car l'image de gauche nous donne la solution: il suffit de définir l'aire comme la somme des aires des \ngones\ coloriés par \geogebra. Sympa! Mais comment ce coloriage est-il fait? C'est un classique de l'informatique graphique, mais aussi un moyen de démontrer le faussement simple théorème de Jordan donnant l'intérieur et l'extérieur d'un \ngone. Voici comment cela fonctionne, sans chercher à démontrer les faits indiqués.
%
\begin{itemize}
...
\begin{center}
	\small\itshape
	\includegraphics[scale=.25]{content/polygon/col-area/col-area-odd-even.png}
...
\begin{defi} \label{carea-def}
    ...
    La quantité $\carea{\setproba{L}} = \dsum_{i} \area{\setproba{P}_i}$ sera nommée \og \emph{aire colorée} \fg\ du \ncycle\ $\setproba{L}$.%
    \footnote{
...
\begin{fact}
	...
	$\carea{\setproba{P}} = \area{\setproba{P}}$.
\end{fact}
...
Enquêtons sur le calcul de l'aire d'un \ngone, afin de savoir si l'aire colorée est \og continue \fg. 
...
\begin{multicols}{2}
    ...
    \begin{center}
        ...
        \includegraphics[scale=.35]{content/polygon/col-area/convex-1.png}
    ...
    \begin{center}
        ...
        \includegraphics[scale=.35]{content/polygon/col-area/convex-2.png}
...
\begin{proof}
    ...
    \begin{multicols}{3}
        \small\itshape
        \begin{center}
            \includegraphics[scale=.4]{content/polygon/col-area/triangulation-1.png}
        ...
        \begin{center}
            \includegraphics[scale=.4]{content/polygon/col-area/triangulation-2.png}
        ...
        \begin{center}
            \includegraphics[scale=.4]{content/polygon/col-area/triangulation-3.png}
    ...
    \begin{multicols}{2}
        \small\itshape
    	\begin{center}
        	\includegraphics[scale=.4]{content/polygon/col-area/mini-ear-1.png}
    	...
    	\begin{center}
        	\includegraphics[scale=.4]{content/polygon/col-area/mini-ear-2.png}
	...
	\begin{itemize}
	    ...
	    \begin{multicols}{2}
    	    \small\itshape
    		\begin{center}
        	\includegraphics[scale=.4]{content/polygon/col-area/triangulation-proof-OK.png}
    	...
    	\end{center}
	    	...
	    	\begin{center}
        	\includegraphics[scale=.4]{content/polygon/col-area/triangulation-proof-KO.png}
...
Tout ce qui précède va nous permettre de justifier la continuité de l'aire colorée sur l'ensemble des \ncycles\ de longueur fixée.
...
\begin{fact} \label{carea-cont}
    Soient $n \in \NN_{\geq3}$, $\ell \in \RRsp$ et
    ...
    et enfin $\alpha: \setproba{U} \rightarrow \RRp$ la fonction qui à un uplet de $\setproba{U}$ associe l'aire colorée du \ncycle\ qu'il représente.
   	%
...
\begin{proof}
	Notons $\dcup_{i} \setproba{P}_i$ la frontière de la surface impaire de $\setproba{L}$, et $\setproba{P}_i = A_{i,1} A_{i,2} \cdots A_{i,n_i}$, les $A_{i,j}$ étant soit des sommets de $\setproba{L}$, soit des intersections d'arêtes non contigües.
	Par définition, 
    $\carea{\setproba{L}} = \dsum_{i} \area{\setproba{P}_i}$.
    %
    \begin{itemize}
        \item Si $\dcup_{i} \setproba{P}_i = \emptyset$, alors 
		$\carea{\setproba{L}} = 0$.
		...
		= \frac12 \dsum_{i} \big\lvert
			...
			\big)
		 \big\rvert$
	    selon le fait \ref{carea-ngone}.%
	    \footnote{
	    	Il suffit d'utiliser l'origine $\pt{O}$ du repère comme point de calcul.
		}


		\item Les seules discontinuités possibles sont finalement lorsqu'un point d'intersection disparait, ou est créé.
