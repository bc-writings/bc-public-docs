...
\begin{remark} \label{der-power-serie-gene}
	Les preuves des \refprelis{conv-ray} et \ref{der-power-serie} montrent que, plus généralement,
...
\begin{proof}
    Nous allons voir que le réel $r$ de la \refdefi{def-analytic} convient. Reprenons toutes les notations de cette définition, et considérons $\omega \in \CdiscO{z_0}{r}$.
