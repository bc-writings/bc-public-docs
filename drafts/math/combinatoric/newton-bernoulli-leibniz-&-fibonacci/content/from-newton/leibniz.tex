...
\begin{itemize}
	...
	\begin{stepcalc}[style=sar]
		\big( \pderope[f]{x}{1} + \pderope[f]{y}{1} \big) \circ P(\pi)(x,y)
	\explnext{}
	...
	\item
	\begin{stepcalc}[style=sar]
		P \circ \big( \pderope[f]{x}{1} + \pderope[f]{y}{1} \big) (\pi)(x,y)
	\explnext{}
		P \circ \big( \pderope[f]{x}{1} + \pderope[f]{y}{1} \big) \big( f(x)g(y) \big)
	\explnext{}
...
\explnext{}
    \big( \pderope[f]{x}{1} + \pderope[f]{y}{1} \big)^n \circ P(\pi)(x,y)
\explnext*{$P$ et $\big( \pderope[f]{x}{1} + \pderope[f]{y}{1} \big)$ appliquées à $\pi$ commutent.}{}
    P \circ \big( \pderope[f]{x}{1} + \pderope[f]{y}{1} \big)^n (\pi)(x,y)
\explnext{}
    P \circ \big( \dsum_{k=0}^n \combi[n][k] \pderope[f]{x^k}{k} \circ \pderope[f]{y^{n-k}}{n-k} \big) \big( f(x) g(y) \big)
%\end{stepcalc}
%
