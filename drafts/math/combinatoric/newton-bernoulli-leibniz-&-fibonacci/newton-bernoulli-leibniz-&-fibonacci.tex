...
\section{La formule du binôme de Newton implique...}
    ...
    \subimport*{content/newton-implies}{bino-id}
    
    
    \subsection{Leibniz, le retour}
    
    \subimport*{content/newton-implies}{leibniz}
    
    
    \subsection{Fibonacci via Newton}
    
    \subimport*{content/newton-implies}{fibonacci}
    
    
    \subsection{Bell en écho de Fibonacci}
    
    \subimport*{content/newton-implies}{bell}


    \subsection{La loi binomiale est algébrique}
    
    \subimport*{content/newton-implies}{bino-law}
