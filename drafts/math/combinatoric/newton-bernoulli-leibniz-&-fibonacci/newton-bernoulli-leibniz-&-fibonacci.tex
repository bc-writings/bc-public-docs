...
\section{La loi binomiale révèle...} \label{bino-implies}
    ...
    \subimport*{content/treeview}{facto}
...
%    
%    \subimport*{content/from-newton}{bino-law}
    ...
    \subimport*{content/from-newton}{facto}


    \subsection{La formule d'inversion de Pascal}
    
    \subimport*{content/from-newton}{pascal-inv}
