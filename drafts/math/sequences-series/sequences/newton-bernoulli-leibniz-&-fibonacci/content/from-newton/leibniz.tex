...
\explnext{}
    \big( \pderope[f]{x}{1} + \pderope[f]{y}{1} \big)^n \circ \Lambda(\pi)(x,y)
\explnext*{$\Lambda$ et $\big( \pderope[f]{x}{1} + \pderope[f]{y}{1} \big)$ commutent.}{}
    \Lambda \circ \big( \pderope[f]{x}{1} + \pderope[f]{y}{1} \big)^n (\pi)(x,y)
\explnext{}
    \Lambda \circ \big( \dsum_{k=0}^n \combi[n][k] \pderope[f]{x^k}{k} \circ \pderope[f]{y^{n-k}}{n-k} \big) \big( f(x) g(y) \big)
%\end{stepcalc}
%
