...
\footnote{
    Un autre point d'attaque est l'usage du plan complexe qui aboutit à une approche très synthétique.
}
...
\input{content/triangle-ana-short/triangle-ana-short}
...
\subsection{Les \ncycles\ et les \ngones}
\input{content/polygon/ncycle-ngone/ncycle-ngone}


%\newpage%TEMPO

\subsection{La convexité revisitée}
\input{content/polygon/convex/convex}


\subsection{Aire algébrique d'un \ncycle}
\input{content/polygon/alg-area/alg-area}


\subsection{Au moins une solution}
\input{content/polygon/at-least-one/at-least-one}


\subsection{Solutions, qui êtes-vous?}
\input{content/polygon/sol-must-be/sol-must-be}
