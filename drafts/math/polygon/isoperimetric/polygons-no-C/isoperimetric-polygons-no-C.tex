...
\input{content/triangle/gene/gene}


\subsection{Des preuves courtes non géométriques}
\input{content/triangle/ana-short}
...
\input{content/quadrilateral/rectangle/rectangle}


\subsection{Les parallélogrammes}
\input{content/quadrilateral/parallelogram/parallelogram}


\subsection{Le cas général}
\input{content/quadrilateral/gene/gene}
