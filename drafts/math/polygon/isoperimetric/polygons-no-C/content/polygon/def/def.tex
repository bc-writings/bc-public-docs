...
\begin{defi}
	...
	et $A_1$ sera dit \onedef{origine} du \ncycle.
\end{defi}
...
\begin{defi}
	Les \onedef{côtés} d'un \ncycle\ $\setproba{L} = A_1 A_2 \cdots A_n$ sont les segments
	$[A^{\,\prime}_i A^{\,\prime}_{i+1}]$ pour $i \in \ZintervalC{1}{n}$,
	et
	la \onedef{longueur} de $\setproba{L}$ est définie par $\cyclelen{\setproba{L}} = \dsum_{i=1}^{n} A^{\,\prime}_i A^{\,\prime}_{i+1}$.
\end{defi}


\begin{defi}
	Un \ncycle\ $\setproba{L} = A_1 A_2 \cdots A_n$ est dit \onedef{convexe} si, pour chaque côté $[A^{\,\prime}_i A^{\,\prime}_{i+1}]$, tous les sommets de $\setproba{L}$ sont dans un même demi-plan fermé délimité par la droite $(A^{\,\prime}_i A^{\,\prime}_{i+1})$ (un sommet peut donc être sur cette droite).
\end{defi}


\begin{defi}
	Un \ncycle\ est \onedef{dégénéré} s'il a, au moins, trois sommets consécutifs alignés,
	et
	\onedef{totalement dégénéré} si tous ses sommets sont alignés.
\end{defi}
...
\begin{defi}
	...
	Si certains côtés non contigus sont sécants en un point, mais tous les sommets distincts deux à deux, nous parlerons de \onedef{\ngone\ croisé}.%
	\footnote{
...
\begin{defi}
	Un \ngone, croisé ou non, est dit \onedef{équilatéral} si tous ses côtés sont de même mesure.
\end{defi}


\begin{defi}
	Un \ngone, croisé ou non, est dit \onedef{équiangle} si tous ses angles au sommet sont de même mesure.
\end{defi}


\begin{defi}
	Un \ngone, croisé ou non, est dit \onedef{régulier} s'il est à la fois équiangle et équilatéral.
\end{defi}
