...
\begin{remark} 
    ...
    %
    \begin{center}
    	\includegraphics[scale=.3]{content/polygon/ncycle-ngone/some-ncycles-ngones.png}
    \end{center}
...
\begin{remark}
	Il existe des \nregs\ et croisés: par exemple, ci-dessous, le tridécagone régulier croisé $ABCDEFGAHIJKL$, est la \focus{réunion} de l'heptagone $ABCDEFG$ et de l'hexagone $AHIJKL$, tous les deux étant réguliers, non croisés.
