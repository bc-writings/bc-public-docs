...
\begin{proof}
	...
	Ce fait découle directement de la stricte décroissance de la fonction $f$ définie sur $\RR_{>2}$ par $f(x) = x \tan (\frac{\pi}{x})$, ceci venant des équivalences logiques suivantes où $x > 1$, la dernière assertion étant vraie d'après la validité de $\sin X \leq X$ sur $\RRp$.
	...
	\explnext{}
		2 \sin (\frac{\pi}{2 x}) < \frac{\pi}{x}
	\explnext{}
		\sin (\frac{\pi}{2 x}) < \frac{\pi}{2 x}
	\end{stepcalc}
