...
\begin{proof}
	...
	%
	Pour avoir le bon nombre de sommets, il suffit d'appliquer le fait \ref{bigger-convex} au convexe $\setproba{E}$ avec $s = n - k$ et $L = \perim{\setproba{P}}$.
	Ceci nous donne un \ngone\ convexe $\primeit{\setproba{C}}$ vérifiant à la fois
	$\area{\setproba{E}} < \area{\primeit{\setproba{C}}}$
	et
