...
le fait \ref{at-least-one-kgone}
...
%        %
%        \begin{enumerate}
%        	\item Supposons que trois sommets $\primeit{A}_i$, $\primeit{A}_{i+1}$ et $\primeit{A}_{i+2}$ soient alignés.
%			%
%			XXXX   DESSIN !
%			pas bon via triangle cassant la ligne des trois points
%			
%			
%        	\item Supposons l'existence de $(k, i) \in \ZintervalC{1}{n}^2$ où $k \neq i$ tel que $[\primeit{A}_i \primeit{A}_{i+1}]$ et $[\primeit{A}_k \primeit{A}_{k+1}]$ soient deux côtés non contigus sécants.
%			%
%			XXXX   DESSIN !
%			si se croise c'est cas plat mais rejeter avant
%
%
%        	\item Supposons l'existence de $(k, i) \in \ZintervalC{1}{n}^2$ où $k \neq i$ tel que $\primeit{A}_i = \primeit{A}_k$.
%			%
