...
\begin{proof}
    ...
    \begin{itemize}
        ...
        %
        \begin{center}
        	\includegraphics[scale=.3]{content/polygon/at-least-one/algo-kgone-terminate-1.png}
        \end{center}
        ...
        %
        \begin{center}
        	\includegraphics[scale=.3]{content/polygon/at-least-one/algo-kgone-terminate-2.png}
        \end{center}
        ...
        %
        \begin{center}
        	\includegraphics[scale=.3]{content/polygon/at-least-one/algo-kgone-terminate-3.png}
        \end{center}
