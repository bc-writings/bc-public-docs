...
\begin{proof}
    ...
    \begin{itemize}
		...
		\item Par convexité de $\setproba{C}$, nous avons l'une des deux configurations génériques suivantes où les demi-droites vertes en pointillés, portées par les côtés contigus à $[AB]$, \focus{dessinent} avec $[AB]$ une région grisée qui est ouverte et à l'extérieur de $\setproba{C}$. 
		...
		Par convexité, $]B \primeit{B}[$ est inclus dans la zone grisée.
		La figure suivante représente notre situation.
		%
		\begin{center}
