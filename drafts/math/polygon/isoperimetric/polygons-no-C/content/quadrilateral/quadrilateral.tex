...
\begin{proof}
    ...
    \footnote{
    	Un quadrilatère $\setproba{Q}$ sans angle rentrant est forcément convexe, c'est-à-dire tel que pour toute paire de points $M$ et $N$ de la surface fermée \focus{intérieure} formée par $\setproba{Q}$, le segment $[MN]$ est dans cette surface.
    }
