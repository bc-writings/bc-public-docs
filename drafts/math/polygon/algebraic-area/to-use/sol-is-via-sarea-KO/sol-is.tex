...
\begin{fact} \label{gene-sol-is-ngone}
	Si un \ncycle\ $\setproba{L}$ n'est pas un \ngone, alors on peut construire un \kcycle\ $\setproba{L}^{\,\prime}$, où $k \leq n$, tel que
	$\perim{\setproba{L}^{\,\prime}} = \perim{\setproba{L}}$
	et
	$\area{\setproba{L}^{\,\prime}} > \area{\setproba{L}}$.
\end{fact}


\begin{proof}
    L'exemple ci-dessous montre que la démonstration va demander quelques précautions: le \ncycle\ proposé a été construit via une spirale positive depuis le point $A$, de sorte que les déterminants pour calculer l'aire généralisée sont tous positifs, ceci donnant une aire généralisée supérieure à celle de l'enveloppe convexe du \ncycle.
	
	\newpage % TEMPO
	
	\begin{multicols}{2}
	    \small\itshape\centering
    	\includegraphics[scale=.4]{content/polygon/sol-is/gene-area-ncycle-not-opti-pb-1.png}

    	\includegraphics[scale=.4]{content/polygon/sol-is/gene-area-ncycle-not-opti-pb-2.png}
	\end{multicols}
	
	
	Notons $\setproba{L} = A_1 A_2 \cdots A_n$.
...
%
%	\begin{center}
%		\includegraphics[scale=.4]{content/polygon/sol-is/non-convex-trap.png}
%	\end{center}
%
%
...
%
%	\begin{center}
%		\includegraphics[scale=.4]{content/polygon/sol-is/non-convex-bad.png}
%	\end{center}
%
%
...
%
%	\begin{center}
%		\includegraphics[scale=.4]{content/polygon/sol-is/convex-hull.png}
%	\end{center}
%	
%	
%	\newpage
...
%
%	\begin{center}
%		\includegraphics[scale=.4]{content/polygon/sol-is/convex-hull-distortion.png}
%	\end{center}
%
%
...
%			\centering
%
%			\includegraphics[scale=.4]{content/polygon/sol-is/add-vertex-1.png}
%
%			\includegraphics[scale=.4]{content/polygon/sol-is/add-vertex-2.png}
%		\end{multicols}
%
