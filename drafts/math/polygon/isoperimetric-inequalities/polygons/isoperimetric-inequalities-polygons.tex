...
\NewDocumentCommand{\perim}{m}{\mathrm{Long}(#1)}
...
%\input{content/polygon/def}
%
%
%\subsection{Aires généralisée et algébrique d'un \ncycle}
%\input{content/polygon/signed-area/signed-area}
%
%
%\subsection{Au moins une solution généralisée}
%\input{content/polygon/at-least-one}
%
%
\subsection{Solutions généralisées, qui êtes-vous?}
\input{content/polygon/sol-is/sol-is}
%%
%%
