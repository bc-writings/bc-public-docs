...
\NewDocumentCommand{\genearea}{m}{\mathrm{AireGene}(#1)}
\NewDocumentCommand{\geoarea}{m}{\mathrm{AireGeo}(#1)}
...
\subsection{Aire géométrique d'un \ncycle}
\input{content/polygon/geo-area/geo-area}
%
%
