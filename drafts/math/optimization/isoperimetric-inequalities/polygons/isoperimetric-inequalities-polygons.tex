...
%\footnote{
%	Une démonstration très synthétique se fait via les nombres complexes. Ceci fera l'objet d'un autre document dès que possible.
%}
%
%
%\begin{tcolorbox}
