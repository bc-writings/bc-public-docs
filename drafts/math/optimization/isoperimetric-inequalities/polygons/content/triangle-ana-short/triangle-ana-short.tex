...
Nous donnons ici des preuves courtes du fait \ref{iso-tri}, mais sans notion géométrique intuitive. Efficacité vs beauté, l'auteur a choisi son camp depuis longtemps !
...
\begin{proof}[\altproof{1}]
	...
	La comparaison des moyennes géométriques et arithmétiques%
	\footnote{
		...
		À l'ordre $2$,
%		Aux ordres $2$ et $3$,
		l'inégalité s'obtient aisément par un argument géométrique: voir la remarque \ref{ineq-geo-quad-arith}.
	}
	donne
