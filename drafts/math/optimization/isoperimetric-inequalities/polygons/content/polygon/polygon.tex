...
%
%\begin{defi}
%	Un \og \emph{\ngone} \fg\ désigne un polygone non croisé à $n$ côtés de mesure non nulle, avec $n \geq 3$.
%\end{defi}
%
%
%\begin{defi}
...
\begin{proof}
	...
	Pour voir que cette condition nécessaire est suffisante, comme dans la remarque \ref{tri-topo-comp}, nous allons convier le couple continuité/compacité.
	%	
	\begin{itemize}
