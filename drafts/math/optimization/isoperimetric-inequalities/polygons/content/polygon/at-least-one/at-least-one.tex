...
\begin{proof}
    ...
    \begin{itemize}
        ...
        Cette fonction est continue comme valeur absolue d'une fonction polynomiale grâce au fait \ref{garea-ngone} (ne pas oublier de prendre en compte le cas d'une famille de \ngones\ tendant vers un \ncycle\ dégénéré).
...
\begin{proof}
    Il suffit de convier les faits \ref{garea-ncycle}, \ref{garea-ngone} et \ref{suff-cond-ncycle}.
\end{proof}
