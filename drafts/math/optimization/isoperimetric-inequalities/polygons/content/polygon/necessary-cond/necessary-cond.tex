...
\begin{proof}
	Les cas $n = 3$ et $n = 4$ ayant été traités précédemment, nous allons supposer que $n \geq 5$.
...
%	Malheureusement, cette preuve échoue lors de la disparition d'un sommet en choisissant les deux triangles isocèles optimaux pour construire un nouveau \ngone\ \og plus gros \fg\,, sauf à affiner la recherche comme nous l'avons fait ci-dessus, si tant est que cela soit faisable.
%	Notons aussi que la preuve du résultat de Zénodore est un peu fastidieuse, sans être ingrate.
%\end{remark}
