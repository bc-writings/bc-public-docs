Nous allons établir que la condition nécessaire donnée par le fait \ref{nece-cond} est aussi une condition suffisante. Pour cela, nous avons juste besoin de savoir qu'il existe au moins un \ngone\ d'aire maximale.
