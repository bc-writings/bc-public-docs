...
Comme $E(1 ; 0)$ correspond au neutre de $\star$, il est immédiat de noter que les procédés de construction sont vrais lorsque que $M = E$ ou $N = E$.
...
\begin{enumerate}
	...
	\noindent
	Or $y = y'= 0$ est exclus ici, donc $y = \pm y'$ donne $y \neq 0$ et $y'\neq 0$, puis $x' y = - x y'$ et $x \neq x'$ impliquent
	$(x' ; y') = (- x ; y)$.
	Nous obtenons alors
...
% --------------- %
	...
	la tangente à $\setproba{H}$ en $M$ admet $\vect{u} ( 16y ; 2x )$ pour vecteur directeur.
	%
