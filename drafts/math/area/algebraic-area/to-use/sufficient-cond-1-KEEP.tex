...
\begin{multicols}{2}
    ...
    \begin{center}
        \includegraphics[scale=.35]{content/polygon/sufficient-cond/inside-outside-ngone.png}
    ...
    \begin{center}
        \includegraphics[scale=.35]{content/polygon/sufficient-cond/inside-outside-not-ngone.png}
...
% .28 + 2.22 - 5.36 - 3.16 - 4.28
Nous obtenons bien $\abs{\num{.28} + \num{2.22} - \num{5.36} - \num{3.16} - \num{4.28}} = \num{10.3}$.
...
\begin{center}
    \includegraphics[scale=.4]{content/polygon/sufficient-cond/garea-danger.png}
\end{center}
