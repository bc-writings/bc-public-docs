...
\footnote{%
    Quoique... Le très bon livre de vulgarisation \oneBook{Le fascinant nombre $\pi$} de \oneAuthor{Jean-Paul}{Delahaye} contient beaucoup d'informations intéressantes.%
},
...
\footnote{%
    Étrange quand on obtient un résultat qui est juste $\ii^2$...%
}.
