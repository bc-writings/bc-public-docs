...
\begin{meta-abstract*}
	Dans ce document, via des arbres binaires complets, puis la formule du binôme de Newton, nous faisons émerger des liens naturels, via les coefficients binomiaux $\binom{n}{k}$, entre notamment
