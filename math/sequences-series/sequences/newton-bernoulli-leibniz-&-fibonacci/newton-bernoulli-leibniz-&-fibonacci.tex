...
\date{2 Avril 2025 - 17 Avril 2025}
...
\begin{meta-abstract*}
	Dans ce document, via des arbres binaires complets, puis la formule du binôme de Newton, nous faisons émerger des liens naturels entre, notamment,
	la formule du binôme de Newton,
	celle de dérivation de Leibniz,
	et la loi binomiale
	qui utilisent des coefficients binomiaux $\binom{n}{k}$.
\end{meta-abstract*}
