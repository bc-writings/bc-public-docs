...
\begin{remark} \label{der-power-serie-gene}
	Une relecture des preuves des \refprelis{conv-ray} et \ref{der-power-serie} donnent que pour toute série entière complexe $\sum_{n=0}^{+\infty} a_n z^n$ de rayon de convergence $R$ non nul,
	...
	\begin{itemize}
        ...
        \begin{multicols}{2}
	        ...
	        \begin{enumerate}[wide]
        		...
        		\explnext{}
        			\dsum_{n = 0}^{+\infty} \dfrac{1}{n!} (z - \omega)^n \big( \dsum_{k = n}^{+\infty} \frac{k!}{(k-n)!} a_{k} \omega^{k-n} \big) 
        		\explnext{}
        			\dsum_{n = 0}^{+\infty} \dfrac{\der[e]{f}{z}{n}(\omega)}{n!} (z - \omega)^n
        		\end{stepcalc}
    		\end{enumerate}
	\end{multicols}
	\end{itemize}
